    ...
    <section className="flex flex-col md:flex-row p-12 h-auto bg-[#011B32]">
      <div className="md:w-4/12 text-center leading-loose md:text-left">
        ...
        <p className="mt-4 text-left">
          Coinvent is a decentralized crowdfunding platform built on the Ethereum blockchain that enables entrepreneurs
          to raise funds for their projects on a global scale in cryptocurrency.
        </p>
        <p>
          We aim to leverage Optimism&apos;s scalability, low transaction fees, and compatibility with Ethereum to
      ...
      <div className="md:w-8/12 flex flex-wrap justify-center md:justify-start mt-8 md:mt-0">
        ...
        <div className="w-1/2 p-4 text-center flex flex-col items-center">
          ...
          <p className="mt-2 text-center">We help tech startups to get funds that enable them to launch projects.</p>
        </div>
        <div className="w-1/2 p-4 text-center flex flex-col items-center">
          <Image src={AboutIcon} alt="Icon 2" className="w-12 h-12" />
          <h4 className="mt-2 font-bold">Leverages Blockchain</h4>
          <p className="mt-2 text-center">
            We use blockchain technology to offer secure transactions and a reliable environment for managing funds and
